...
if (!EMULATE_DVS_EXE){  
	...
	c('fmPHPEditor')->position = poDesigned;
	myOptions::getXYWH('fmPHPEditor', c('fmPHPEditor'), ['x'=>0,'y'=>0,'w'=>719,'h'=>563]);
	c('fmPHPEditor')->windowState = myOptions::get('fmPHPEditor', 's', wsNormal);

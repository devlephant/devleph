...
$result[] = array('CAPTION'=>t('Text'),'TYPE'=>'text','PROP'=>'caption','UPDATE_DSGN'=>1);
_addfont($result);
...
$result[] = array('CAPTION'=>t('Interval (ms)'), 'PROP'=>'IntervalTimer', 'TYPE'=>'number','ADD_GROUP'=>1,'UPDATE_DSGN'=>1);

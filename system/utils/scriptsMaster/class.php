...
$file = file_exists(DOC_ROOT . 'design/theme/' . myOptions::get('prefs','studio_theme', 'light') . '/icon_scriptsMaster.bmp')? DOC_ROOT . 'design/theme/' . myOptions::get('prefs','studio_theme', 'light') . '/icon_scriptsMaster.bmp': dirname(__FILE__).'/icon.bmp'; //#ADDOPT;

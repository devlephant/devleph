...
class myProject {
    ...
    static function checkOldFormat(){
        ...
        if (self::cfg('DV_VERSION')=='' || self::cfg('DV_VERSION')=='2.0.0.0'){
            alert(t("¬ы пытаетесь загрузить проект старого формата. ƒанный формат будет конвертирован!"));
            return false;
    ...
    static function save($file = false){
        ...
        // в событии сохранени€ передавалс€ $self элемента меню, из-за чего в файл подставл€лс€ $self - индетификатор
